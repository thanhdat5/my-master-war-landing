...
NioApp = (function(NioApp, $) {
    ...
    NioApp.Chart.ChartJs = function() {
        ...
        NioApp.Chart.ChartJs.Doughnut2 = function(_canvas, _titles, _colors, _amounts, _canvas_border) {
            if ($('#' + _canvas).length) {
                var _canvas_el = document.getElementById(_canvas).getContext("2d");
                var doughnut_chart = new Chart(_canvas_el, {
                    type: 'doughnut',
        ...
        if ($chart_3.length > 0) {
            $chart_3.each(function() {
                ...
                if (typeof _canvas !== 'undefined' && _canvas !== '') {
                    ...
                    if (_canvas_type === 'doughnut') {
                        NioApp.Chart.ChartJs.Doughnut2(_canvas, item_label, item_color, item_percent, _canvas_border);
                    } else if (_canvas_type === 'pie') {
