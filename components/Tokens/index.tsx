                ...
                <ul className={`${styles.chart_data} row wow fadeInUp`} id="tq-chart-legends">
                  ...
                  <li className="col-sm-6">
                    <div className={styles.chart_data_item}>
                      ...
                      <span className={styles.chart_info}>
                        <span className={styles.chart_percent}>6% </span>
                        <span className={styles.chart_sublabel}>(6,000,000 token)</span>
                      </span>
                    </div>
                  </li>
                  <li className="col-sm-6">
                    <div className={styles.chart_data_item}>
                      ...
                      <span className={styles.chart_info}>
                        <span className={styles.chart_percent}>5% </span>
                        <span className={styles.chart_sublabel}>(5,000,000 token)</span>
                      </span>
                    </div>
                  </li>
                </ul>
