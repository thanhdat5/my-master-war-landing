...
import { ChainId, DEPOSIT_CONTRACT } from 'literals'
...
export function getDepositContract(_: number, library: Web3Provider, account?: string): Contract {
  return getContract(`${DEPOSIT_CONTRACT}`, DEPOSIT_MAT_ABI, library, account)
}