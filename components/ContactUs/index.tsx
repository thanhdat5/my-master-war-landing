            ...
            <div className={styles.tq_contact_inner}>
                ...
                <div className={styles.tq_contact_body}>
                    <Row className="align-items-center">
                        <Col xl="7" lg="6">
                            <img src="/images/welcome.png" alt="" style={{ maxWidth: '100%' }} />
                        </Col>
                        <Col xl="5" lg="6">
                            <p className="fs-18 mb-4">We are always open and we welcome and questions you have for our team. If you wish to get in touch, please fill out the form below. Someone from our team will get back to you shortly.</p>
